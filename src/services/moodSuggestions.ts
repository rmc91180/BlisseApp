...
const MOOD_LINES: Record<AppLanguage, Record<string, { why: string; how: string; short: string; unfold: string; playful: string; close: string }>> = {
  ...
  hi: {
    ...
    passionate: { why: 'यह गर्म vibe में फिट बैठता है, बिना staged लगे।', how: 'Simple, direct और बदलने में आसान।', short: 'छोटा और sweet भी अच्छा है।', unfold: 'अच्छा लगे तो इसे खुलने दें।', playful: 'इतना हल्का रखें कि मुस्कान बनी रहे।', close: 'इतने करीब रहें कि एक-दूसरे को आसानी से पढ़ सकें।' },
    ...
    commanding: { why: 'यह confident और warm vibe में फिट बैठता है।', how: 'एक अपना tone रख सकता है, बदलने की पूरी जगह के साथ।', short: 'छोटा और sweet भी अच्छा है।', unfold: 'अच्छा लगे तो इसे खुलने दें।', playful: 'इतना हल्का रखें कि मुस्कान बनी रहे।', close: 'इतने करीब रहें कि एक-दूसरे को आसानी से पढ़ सकें।' },
