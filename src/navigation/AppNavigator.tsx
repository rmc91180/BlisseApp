...
function SubscriptionPaywallScreen({ route }: { route?: { params?: { trigger?: 'trial_expired' | 'manual' | 'banner' } } }) {
  ...
  const copy = {
    en: {
      ...
      fullAccess: 'More ways to follow your vibe',
      monthlyHighlight: 'Stay flexible',
      annualHighlight: 'More room to play',
      lifetimeHighlight: 'Keep it open',
      weeklyHighlight: 'Easy to ease in',
      recurringNote: 'Cancel anytime in your App Store settings.',
      lifetimeNote: 'One quiet unlock, always here.',
      saveVsMonthly: 'A little more room for the year',
    ...
    es: {
      ...
      fullAccess: 'Más formas de seguir su vibe',
      monthlyHighlight: 'A su ritmo',
      annualHighlight: 'Más espacio para jugar',
      lifetimeHighlight: 'Siempre abierto',
      weeklyHighlight: 'Entrar suave',
      recurringNote: 'Puedes cancelar cuando quieras desde App Store.',
      lifetimeNote: 'Un desbloqueo tranquilo, siempre aquí.',
      saveVsMonthly: 'Más espacio para todo el año',
    ...
    pt: {
      ...
      fullAccess: 'Mais jeitos de seguir a vibe',
      monthlyHighlight: 'No ritmo de vocês',
      annualHighlight: 'Mais espaço pra brincar',
      lifetimeHighlight: 'Sempre aberto',
      weeklyHighlight: 'Entrar de leve',
      recurringNote: 'Cancele a qualquer momento na App Store.',
      lifetimeNote: 'Um desbloqueio tranquilo, sempre aqui.',
      saveVsMonthly: 'Mais espaço para o ano todo',
    ...
    hi: {
      ...
      fullAccess: 'अपनी vibe के साथ चलने के और तरीके',
      monthlyHighlight: 'अपनी pace में',
      annualHighlight: 'खेलने की और जगह',
      lifetimeHighlight: 'हमेशा खुला',
      weeklyHighlight: 'धीरे से शुरू',
      recurringNote: 'आप App Store सेटिंग्स में कभी भी रद्द कर सकते हैं।',
      lifetimeNote: 'एक शांत unlock, हमेशा यहीं।',
      saveVsMonthly: 'पूरे साल के लिए और जगह',
