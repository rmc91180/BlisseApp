  ...
  if (language === 'es') {
    return {
      ...
      home: {
        ...
        vibeQuestion: 'Esta noche',
        setTonightVibe: 'Vibra de esta noche',
        vibeHelper: 'Elijan cómo se siente. Lo demás acompaña suave.',
        ...
        whyBlisse: 'Por qué Blisse',
        dailyRitual: [
          'Un momento pequeño para ustedes esta noche.',
          'Una pausa compartida, solo para ustedes.',
          'Como sea que se sienta la noche, acá tiene lugar.',
        ],
        privacyLine: 'Este espacio se queda entre ustedes.',
        quietWinsHidden: 'Momentos que les gustaron',
        quietWinsShown: 'Guardar esos momentos cerca',
        moods: {
        ...
        profile: {
          rhythmHeading: 'Lo suyo',
          ideasPlayed: (count) => `${count} momentos guardados`,
          styleWarmup: 'Ya se nota lo que se siente bien para ustedes 🌱',
          youLeanInto: 'Ustedes van por:',
          styleUpdates: 'Esto se va sintiendo más suyo con el tiempo',
        },
      },
      suggestion: {
      ...
      progress: {
        ...
        streak: ['Qué lindo verlos acá 🔥', 'Su ritmo sigue cerca 🔥', 'Esto se siente muy suyo 🔥'],
        weekComplete: ['Esto se sintió bien.', 'Hicieron espacio para ustedes.', 'Qué lindo volver a encontrarse.'],
        encouragement: ['Vayan suave 🌸', 'Sin apuro 🌸', 'Como se sienta bien 🌸'],
        cardTitle: 'Momentos guardados',
        cardPreparing: 'Guardando esto suave...',
        cardCollapsedA11y: 'Mostrar momentos guardados',
        cardExpandedA11y: 'Ocultar momentos guardados',
      },
      return: {
      ...
      labels: {
        ...
        activityLog: 'Momentos guardados',
        interactionHistory: 'Lo que tocaron',
      ...
      dailyBonus: {
        title: 'Un detalle para hoy',
        dayStreak: () => 'Un pequeño momento los estaba esperando.',
        collect: (count) => `Guardar ${count} ⭐`,
        collected: (count) => `${count} ⭐ guardadas`,
        caption: 'Mañana puede sentirse distinto. Su lugar queda acá.',
      },
      moodCheck: {
      ...
      sessionRating: {
        ...
        doneSimple: 'Listo',
        saveWorked: 'Guardar este momento ❤️',
        ...
        starsEarnedTitle: (count) => `${count} ⭐ guardadas`,
        starsEarnedSubtitle: 'Un poco de calidez guardada',
        achievements: 'Nuevas insignias',
        noAchievements: 'Sin insignia nueva. Igual quedó algo lindo.',
        done: 'Listo por hoy →',
        rateA11y: (value) => `Calificar ${value} estrellas`,
        fallbackCloser: 'Ahora no nos necesitan. Vayan a disfrutarse.',
      ...
      notifications: {
        ...
        streakTitle: 'Un espacio suave para volver ✨',
        streakBodies: [
          'Anduvieron ocupados. Aquí seguimos 🌸',
          'Sin presión. Solo algo pequeño para hoy.',
          'Su lugar sigue acá, cuando se antoje volver 🔥',
        ],
        reactivationTitle: 'Seguimos acá ✨',
        reactivationBodies: [
          'Hay algo nuevo guardado para cuando quieran.',
          'Seguimos aquí, con algo suave para ustedes 🌸',
  ...
  if (language === 'pt') {
    return {
      ...
      home: {
        ...
        vibeQuestion: 'Esta noite',
        setTonightVibe: 'Vibe da noite',
        vibeHelper: 'Escolham como ela se sente. O resto acompanha leve.',
        ...
        whyBlisse: 'Por que Blisse',
        dailyRitual: [
          'Um momento pequeno pra vocês hoje.',
          'Uma pausa compartilhada, só de vocês.',
          'Do jeito que a noite estiver, tem espaço aqui.',
        ],
        privacyLine: 'Esse espaço fica só de vocês.',
        quietWinsHidden: 'Momentos que vocês gostaram',
        quietWinsShown: 'Guardar esses momentos por perto',
        moods: {
        ...
        profile: {
          rhythmHeading: 'O jeito de vocês',
          ideasPlayed: (count) => `${count} momentos guardados`,
          styleWarmup: 'Já dá pra sentir o que bate bem pra vocês 🌱',
          youLeanInto: 'Vocês curtem mais:',
          styleUpdates: 'Isso vai ficando mais de vocês com o tempo',
        },
      },
      suggestion: {
      ...
      progress: {
        ...
        streak: ['Bom ver vocês por aqui 🔥', 'O ritmo de vocês continua perto 🔥', 'Isso parece muito vocês 🔥'],
        weekComplete: ['Isso bateu gostoso.', 'Vocês abriram espaço um pro outro.', 'Foi bonito se encontrar de novo.'],
        encouragement: ['Vão com calma 🌸', 'Sem pressa 🌸', 'Do jeito que bater bem 🌸'],
        cardTitle: 'Momentos guardados',
        cardPreparing: 'Guardando isso com calma...',
        cardCollapsedA11y: 'Mostrar momentos guardados',
        cardExpandedA11y: 'Esconder momentos guardados',
      },
      return: {
      ...
      labels: {
        ...
        activityLog: 'Momentos guardados',
        interactionHistory: 'O que vocês tocaram',
      ...
      dailyBonus: {
        title: 'Um carinho pra hoje',
        dayStreak: () => 'Um pequeno momento estava esperando vocês.',
        collect: (count) => `Guardar ${count} ⭐`,
        collected: (count) => `${count} ⭐ guardadas`,
        caption: 'Amanhã pode ter outro clima. O lugar de vocês fica aqui.',
      },
      moodCheck: {
      ...
      sessionRating: {
        ...
        starsEarnedTitle: (count) => `${count} ⭐ guardadas`,
        starsEarnedSubtitle: 'Um pouco de calor guardado',
        achievements: 'Novas insígnias',
        noAchievements: 'Sem insígnia nova. Ainda assim ficou algo gostoso.',
        done: 'Encerrar por hoje →',
        rateA11y: (value) => `Avaliar com ${value} estrelas`,
        fallbackCloser: 'Vocês não precisam da gente agora. Vão curtir um ao outro.',
      ...
      notifications: {
        ...
        streakTitle: 'Um espaço gostoso pra voltar ✨',
        streakBodies: [
          'Vocês andaram ocupados. Estamos aqui 🌸',
          'Sem pressão. Só algo pequeno pra hoje.',
          'O lugar de vocês continua aqui, quando bater vontade 🔥',
        ],
        reactivationTitle: 'Seguimos por aqui ✨',
        reactivationBodies: [
          'Tem algo novo guardado pra quando vocês quiserem.',
          'A gente continua aqui, com algo suave pra vocês 🌸',
  ...
  if (language === 'hi') {
    return {
      ...
      home: {
        ...
        vibeQuestion: 'आज रात',
        setTonightVibe: 'आज रात का माहौल',
        vibeHelper: 'माहौल चुनें। बाकी सब नरमी से साथ चलेगा।',
        ...
        whyBlisse: 'Blisse क्यों',
        dailyRitual: [
          'आज आप दोनों के लिए एक छोटा-सा पल।',
          'एक साझा ठहराव, सिर्फ़ आप दोनों के लिए।',
          'आज रात जैसी भी लगे, यहाँ उसके लिए जगह है।',
        ],
        privacyLine: 'यह जगह सिर्फ़ आप दोनों की है।',
        ...
        profile: {
          rhythmHeading: 'आप दोनों का तरीका',
          ideasPlayed: (count) => `${count} पल सहेजे गए`,
          styleWarmup: 'जो अच्छा लगता है, वह धीरे-धीरे दिखने लगा है 🌱',
          youLeanInto: 'आप ज़्यादा पसंद करते हैं:',
          styleUpdates: 'समय के साथ यह और आपका लगता है',
        },
      },
      suggestion: {
      ...
      progress: {
        ...
        streak: ['आप दोनों को यहाँ देखना अच्छा है 🔥', 'आपकी लय पास ही है 🔥', 'यह बहुत आप दोनों जैसा लगता है 🔥'],
        weekComplete: ['यह अच्छा लगा।', 'आपने एक-दूसरे के लिए जगह बनाई।', 'फिर से मिलना सुंदर लगा।'],
        encouragement: ['आराम से 🌸', 'बिना जल्दी 🌸', 'जैसा अच्छा लगे 🌸'],
        cardTitle: 'सहेजे हुए पल',
        cardPreparing: 'इसे नरमी से संभाल रहे हैं...',
        cardCollapsedA11y: 'सहेजे हुए पल दिखाएँ',
        cardExpandedA11y: 'सहेजे हुए पल छुपाएँ',
      },
      return: {
      ...
      dailyBonus: {
        ...
        dayStreak: () => 'एक छोटा-सा पल आपका इंतज़ार कर रहा था।',
        collect: (count) => `${count} ⭐ सहेजें`,
        collected: (count) => `${count} ⭐ सहेजे गए`,
      ...
      notifications: {
        ...
        streakTitle: 'वापस आने के लिए एक नरम जगह ✨',
        streakBodies: [
          'आप दोनों व्यस्त थे। हम यहीं हैं 🌸',
          'कोई दबाव नहीं। बस आज के लिए एक छोटी-सी बात।',
          'आपकी जगह यहीं है, जब लौटने का मन हो 🔥',
        ],
        reactivationTitle: 'हम अभी भी यहीं हैं ✨',
        reactivationBodies: [
          'जब मन हो, आपके लिए कुछ नया रखा है।',
          'हम यहीं हैं, आप दोनों के लिए कुछ नरम लेकर 🌸',
...
Write the final note in Hindi.`,
  ...
  return {
    ...
    home: {
      ...
      vibeQuestion: 'Tonight',
      setTonightVibe: 'Tonight\'s vibe',
      vibeHelper: 'Choose how it feels. The rest can follow softly.',
      ...
      dailyRitual: [
        ...
        'However tonight feels, there is room for it here.',
      ],
      privacyLine: 'This space stays between you two.',
      quietWinsHidden: 'Moments you liked',
      quietWinsShown: 'Keep those moments close',
      moods: {
      ...
      profile: {
        ...
        styleWarmup: 'We are starting to notice what feels good for you two 🌱',
        youLeanInto: 'You lean into:',
        styleUpdates: 'This gets more yours over time',
      },
    },
    suggestion: {
    ...
    progress: {
      ...
      streak: ['Good to see you here 🔥', 'Your rhythm is still close 🔥', 'This feels like you two 🔥'],
      weekComplete: ['That felt good.', 'You made room for each other.', 'A sweet little return.'],
      encouragement: ['Take it easy 🌸', 'No rush 🌸', 'Follow what feels good 🌸'],
      cardTitle: 'Moments you liked',
      cardPreparing: 'Keeping this soft...',
      cardCollapsedA11y: 'Show moments you liked',
      cardExpandedA11y: 'Hide moments you liked',
    },
    return: {
    ...
    labels: {
      ...
      activityLog: 'Saved moments',
      interactionHistory: 'What you touched',
    ...
    dailyBonus: {
      title: 'A little note for today',
      dayStreak: () => 'A small moment was waiting for you.',
      collect: (count) => `Save ${count} ⭐`,
      collected: (count) => `${count} ⭐ saved`,
      caption: 'Tomorrow can feel different. Your space stays here.',
    },
    moodCheck: {
    ...
    sessionRating: {
      ...
      starsEarnedTitle: (count) => `${count} ⭐ saved`,
      starsEarnedSubtitle: 'A little warmth saved',
      achievements: 'New badges',
      noAchievements: 'No new badge tonight. Something sweet still stayed.',
      done: 'All set for tonight →',
      rateA11y: (value) => `Rate ${value} stars`,
      fallbackCloser: 'You do not need us right now. Go enjoy each other.',
    ...
    notifications: {
      ...
      streakTitle: 'A soft place to come back to ✨',
      streakBodies: [
        'You have been busy. We get it. Still here when you are ready 🌸',
        'No pressure. Just something small for tonight.',
        'Your space is still here whenever you feel like returning 🔥',
      ],
      reactivationTitle: 'Still here for you ✨',
      reactivationBodies: [
        'Something new is tucked away for whenever you want it.',
        'Still here, with something soft for you two 🌸',
