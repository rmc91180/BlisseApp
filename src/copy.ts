...
Write the final note in Hindi.`,
  ...
  return {
    ...
    home: {
      ...
      pickedForTonight: '✨ Picked for Tonight',
      moods: {
      ...
      greeting: {
        ...
        morningContext: 'Start the day with a little connection.',
      ...
      tonightSession: {
        label: 'Tonight Session',
        title: '3 easy guided steps',
        subtitle: 'Mood set → Curated flow → Glow',
        teaser: 'Low effort, high chemistry, and ready in seconds.',
        cta: 'Begin Session →',
      },
    ...
    detail: {
      ...
      closer: ['Stay with it.', 'Let it unfold.', 'You have got this.'],
    ...
    progress: {
      ...
      weekComplete: ['That felt good.', 'Nice rhythm this week.', 'You are on a roll.'],
      encouragement: ['You are right there 🌸', 'Do not stop now 🌸', 'Keep the flow 🌸'],
      cardTitle: 'This Week',
      cardPreparing: 'Setting this week up...',
    ...
    moodCheck: {
      ...
      subheader: 'Pick your energy. We take it from there.',
      cta: 'Let\'s go',
      ctaA11y: 'Let us go',
    },
    sessionPlan: {
    ...
    sessionRating: {
      ...
      fallbackStartLabel: 'Start with...',
      fallbackMoveLabel: 'Move into...',
      fallbackFinishLabel: 'Finish with...',
      coachLabel: 'For you two 🌸',
      coachBody: 'Keep the moments that landed. Those are your shortcuts.',
      remember: 'Keep this',
      optional: 'Optional',
      feelNow: 'Right now',
