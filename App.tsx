...
const firebaseConfig = {
  apiKey: "AIzaSyC4WmM0EG0zGY8uOhduQ10Qsko7MRRSbqE",
  authDomain: "blisse-b538f.firebaseapp.com",
  projectId: "blisse-b538f",
  storageBucket: "blisse-b538f.firebasestorage.app",
  messagingSenderId: "220432903326",
  appId: "1:220432903326:web:168e8e99315dccbd4c1f8f",
...
function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ user, loading, signUp, signIn, signInWithApple, logout, resetPassword }}>
      {children}
...
// ============================================
// Tracks aggregated, anonymous data to understand trends
// NO personal identifiers, NO user IDs, NO device IDs
// Only category/feature popularity counts
...
const useStore = create<UserState>()(
  persist(
    ...
    { name: 'blisse-storage', storage: createJSONStorage(() => AsyncStorage) }
  )
);
...
// ============================================
const sounds = {
  soundRef: null as Audio.Sound | null,
    ...
    <ScreenWrapper>
      ...
      <ScrollView style={styles.screenContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.legalHighlightBox, { marginTop: 20, marginBottom: 24 }]}>
          ...
          <Text style={[styles.legalHighlightTextSmall, { color: themeColors.text.secondary }]}>Your data stays on your device only. We don't store or sell personal information.</Text>
        </View>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { maxHeight: '90%', backgroundColor: themeColors.card }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={true} onScroll={handleTermsScroll} scrollEventThrottle={16}>
              ...
              <Text style={[styles.legalDate, { color: themeColors.text.muted }]}>Last Updated: January 2025</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>1. Acceptance</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>By using Blisse, you agree to these Terms.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>2. Eligibility</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>You must be at least 18 years old.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>3. Service</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Blisse helps couples explore intimacy through suggestions and tracking.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>4. Consent</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>All activities require enthusiastic consent from all parties.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>5. Health</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>This is not medical advice. Consult professionals for health concerns.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>6. Privacy</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Your data stays on your device. See Privacy Policy.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>7. Liability</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Use at your own risk and discretion.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>8. Contact</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Questions? legal@blisse.online</Text>
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.modalContent, { maxHeight: '90%', backgroundColor: themeColors.card }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={true} onScroll={handlePrivacyScroll} scrollEventThrottle={16}>
              ...
              <Text style={[styles.legalDate, { color: themeColors.text.muted }]}>Last Updated: January 2025</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Your Privacy</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Privacy is our top priority given the sensitive nature of this app.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Local Storage</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>All personal data stays on your device. We have no servers storing your info.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Authentication</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Sign-in handled by Apple/Firebase. We don't store credentials.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Analytics</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Only anonymous, aggregated data to improve the app.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>We Never Collect</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Your name, favorites, notes, biometrics, or location.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Your Control</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Delete via Settings or by removing the app.</Text>
              <Text style={[styles.legalSection, { color: themeColors.text.primary }]}>Contact</Text>
              <Text style={[styles.legalText, { color: themeColors.text.secondary }]}>Questions? privacy@blisse.online</Text>
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { maxHeight: '90%' }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.legalText}>By using Blisse ("the App"), you agree to these Terms of Use. If you do not agree, please do not use the App.</Text>
      ...
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { maxHeight: '90%' }]}>
          ...
          <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <Text style={styles.legalSection}>Your Privacy Matters</Text>
            <Text style={styles.legalText}>Blisse is designed with your privacy as our top priority. We understand the sensitive nature of this App and have built it to protect your information.</Text>
            
            <Text style={styles.legalSection}>Personal Data Storage</Text>
            <Text style={styles.legalText}>✓ Your personal data (favorites, notes, progress) is stored ONLY on your device{'\n'}✓ We do NOT have servers that store your personal information{'\n'}✓ Your favorites, notes, and progress never leave your phone{'\n'}✓ If you delete the App, all personal data is permanently deleted</Text>
            
            <Text style={styles.legalSection}>Anonymous Analytics</Text>
            <Text style={styles.legalText}>To improve Blisse, we collect anonymous, aggregated usage data such as:{'\n'}• Which categories are most popular{'\n'}• Which features are used most often{'\n'}• General app engagement trends{'\n\n'}This data is:{'\n'}✓ Completely anonymous - no user IDs or identifiers{'\n'}✓ Aggregated - we only see trends, not individual usage{'\n'}✓ Used solely to improve the app experience</Text>
            
            <Text style={styles.legalSection}>What We Never Collect</Text>
            <Text style={styles.legalText}>• Your name or personal details{'\n'}• Your specific favorites or notes{'\n'}• Any biometric data (Face ID/Touch ID is handled by your device only){'\n'}• Your location{'\n'}• Device identifiers that could identify you{'\n'}• Any data that could link activity to you personally</Text>
            
            <Text style={styles.legalSection}>What We Don't Do</Text>
            <Text style={styles.legalText}>• We don't sell any data{'\n'}• We don't share with third parties{'\n'}• We don't show ads{'\n'}• We don't track individuals{'\n'}• We don't store biometrics (your device handles this securely)</Text>
            
            <Text style={styles.legalSection}>PIN Lock & Biometrics</Text>
            <Text style={styles.legalText}>The optional PIN lock is stored securely on your device only. Face ID/Touch ID authentication is handled entirely by your device's secure enclave - we never see or store biometric data.</Text>
            
            <Text style={styles.legalSection}>Your Rights</Text>
            <Text style={styles.legalText}>Since personal data is on your device, you have complete control. You can delete everything at any time through Settings → Reset All Data.</Text>
            
            <Text style={styles.legalSection}>Contact</Text>
            <Text style={styles.legalText}>Questions about privacy? Use the Contact form in the app to reach us.</Text>
          </ScrollView>
        </View>
      </View>
    </Modal>
...
function ContactModal({ visible, onClose }: { visible: boolean; onClose: () => void }) {
  ...
  const handleSubmit = async () => {
    ...
    // Replace this URL with your actual form endpoint (Formspree, Netlify, custom API, etc.)
    try {
      const response = await fetch('https://formspree.io/f/xvzgeaqp', {
        method: 'POST',
      ...
      // Fallback: Store locally for now (you can sync later)
      console.log('Contact form submission:', { category, message });
      setSubmitted(true);
      haptic.success();
    }
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { maxHeight: '80%' }]}>
          ...
          <Text style={styles.contactPrivacyNote}>Your message is sent anonymously. We don't collect any personal information.</Text>
        </View>
      </View>
    </Modal>
  );
...
function IdeasModal({ visible, onClose }: { visible: boolean; onClose: () => void }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      console.log('Idea submission:', { ideaType, idea });
      setSubmitted(true);
      haptic.success();
    }
    ...
    <Modal visible={visible} animationType="slide" transparent>
      <View style={styles.modalOverlay}>
        <View style={[styles.modalContent, { maxHeight: '80%' }]}>
          ...
          <Text style={styles.contactPrivacyNote}>Ideas are submitted anonymously. We don't collect any personal information.</Text>
        </View>
      </View>
    </Modal>
  );
  ...
  return (
    <LinearGradient colors={[colors.background.primary, colors.background.secondary]} style={styles.lockScreenContainer}>
      <SafeAreaView style={styles.lockScreenContent}>
        ...
        {error ? <Text style={styles.lockScreenError}>{error}</Text> : null}
